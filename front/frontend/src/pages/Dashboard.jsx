...
import { getMapaAssetUrl } from '../api'
...
export default function Dashboard() {
  ...
  if (user) {
    sections.push(
      ...
      { to: '/estabelecimentos', title: 'Estabelecimentos', desc: 'Tavernas, hospedagens e acampamentos da campanha' },
      { to: '/demonios', title: 'Demônios', desc: 'Listar e consultar demônios da campanha' },
      { to: '/animais', title: 'Animais', desc: 'Listar e consultar feras/animais da campanha' },
    )
  }
  ...
  return (
    <div className="dashboard">
      ...
      <div className="card dashboard-story" style={{ marginBottom: '1.5rem', maxWidth: '920px' }}>
        <h2 style={{ marginTop: 0 }}>História do mundo</h2>

        {/* Mapa de Khonum — colapsável */}
        <div className="card dashboard-world-map" style={{ marginBottom: '1rem', background: 'var(--bg-card-hover)' }}>
          <button
            type="button"
            onClick={() => setWorldMapOpen((o) => !o)}
            style={{
              width: '100%',
              textAlign: 'left',
          ...
          >
            <span style={{ fontWeight: 600 }}>Mapa de Khonum</span>
            <span style={{ fontSize: '0.9rem', color: 'var(--parchment-dark)' }}>{worldMapOpen ? '▼' : '▶'}</span>
          </button>
          {worldMapOpen && (
            <div className="dashboard-world-map-body" style={{ padding: '0 0.75rem 0.75rem' }}>
              <p style={{ margin: '0 0 0.75rem', fontSize: '0.9rem', color: 'var(--parchment-dark)', lineHeight: 1.5 }}>
                Vista geral do continente e mares de Khonum — fronteiras, rotas e territórios para consulta rápida na
                mesa.
              </p>
              <div className="dashboard-world-map-frame">
                <img
                  src={getMapaAssetUrl('khonum.jpg')}
                  alt="Mapa mundial de Khonum"
                  className="dashboard-world-map-img"
                  loading="lazy"
                />
              </div>
            </div>
          ...
          {summaryOpen && (
            <div style={{ padding: '0.25rem 0.75rem 0.75rem' }}>
              <ul style={{ margin: 0, paddingLeft: '1.25rem', fontSize: '0.9rem' }}>
                ...
                <li style={{ marginTop: '0.35rem' }}>
                  <button type="button" onClick={() => scrollTo('cap-era-moderna')} className="link-button">
                    A Era Moderna
                  </button>
                  <ul style={{ marginTop: '0.25rem', paddingLeft: '1.25rem' }}>
                    <li>
                      <button type="button" onClick={() => scrollTo('sub-guia-compendio')} className="link-button">
                        Guia de Navegação do Compêndio
                      </button>
                    </li>
                  </ul>
                </li>
        ...
        <div id="cap-era-divinos" className="card" style={{ background: 'var(--bg-card)', marginTop: '1rem', marginBottom: 0 }}>
          <button
            type="button"
            onClick={() =>
        ...
        >
          <button
            type="button"
            onClick={() =>
              setChaptersOpen((prev) => ({ ...prev, eraModerna: !prev.eraModerna }))
            }
            style={{
              width: '100%',
              textAlign: 'left',
          ...
          >
            <span style={{ fontWeight: 700 }}>Capítulo V — A Era Moderna</span>
            <span style={{ fontSize: '0.9rem', color: 'var(--parchment-dark)' }}>
              {chaptersOpen.eraModerna ? '▼' : '▶'}
            </span>
          </button>
          {chaptersOpen.eraModerna && (
            <div style={{ padding: '0 0.75rem 0.75rem', lineHeight: 1.6 }}>
              <p>
                Khonum respira sob uma paz armada. Os Sete Reinos Originais e as novas nações surgidas das revoltas e
                necessidades consolidaram suas fronteiras, mas o solo que pisam é instável. A Era Moderna é definida por
                uma dualidade perigosa: de um lado, o ápice da engenharia rúnica, o florescer das artes em Likan e a
                proteção onipresente dos Totens de Fangi; de outro, o ressurgimento da Ordem dos Kronagar em meio às
                intrigas políticas e o sussurro constante de que os Gorvash, agora mais inteligentes e organizados,
                marcham novamente sob o comando de um novo Messias.
              </p>
              <p>
                Enquanto a nobreza de Rushoku se perde em burocracias e impostos, e os mercadores de Thayta tentam limpar o
                sangue de suas mãos após a guerra contra Fasu, o povo olha para o céu em busca de um sinal. A promessa de
                um libertador dos deuses — um novo Profeta — ecoa das periferias de Lhals aos picos de Naltra. É um
                tempo de mistérios não resolvidos: o paradeiro do 13º herói, a verdadeira natureza do isolamento de
                Meruem e os segredos enterrados sob a Universidade de Acris. Em Khonum, a história não é apenas o que
                passou, mas a arma que todos afiam para o que está por vir.
              </p>
              <h3 id="sub-guia-compendio" style={{ marginTop: '0.75rem', fontSize: '1.05rem' }}>
                Guia de Navegação do Compêndio
              </h3>
              <p>
                Para uma imersão completa na geografia e nos eventos atuais de cada território, utilize as ferramentas de
                consulta abaixo:
              </p>
              <p>
                <strong>Livro dos Reinos:</strong> Clique na aba Reinos e selecione História. Lá, você encontrará as
                paisagens detalhadas, os cenários de campanha e os eventos políticos mais recentes de cada domínio.
              </p>
              <p>
                <strong>Nota:</strong> O mapeamento é um processo contínuo; regiões em exploração podem apresentar
                lacunas até que novos relatos de Mensageiros cheguem.
              </p>
              <p>
                <strong>Guias de Campo:</strong> Explore a aba Guias para entender as mecânicas do mundo, desde a
                fabricação de elixires Vaelthor até as leis de navegação de Tahid.
              </p>
              <p>
                <strong>Glossário de Khonum:</strong> Consulte termos específicos, nomes de heróis lendários e definições
                de criaturas para não se perder nas intrigas das cortes.
              </p>
            </div>
          )}
        </div>
